...
interface UnmarkReceiptAsProcessed_Input {
    id: number
}

export default class UnmarkReceiptAsProcessed implements IUseCase<UnmarkReceiptAsProcessed_Input, ItemValue>{
    constructor(
        private repo_biv: IRepoBaseItemValue,
        private repo_iv: IRepoItemValue
    ){}
    async execute(input: UnmarkReceiptAsProcessed_Input): Promise<ItemValue> {
