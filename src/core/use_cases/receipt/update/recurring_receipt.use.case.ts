...
interface UpdateRecurringReceipt_Input {
    id: number;
    patch: {
...
export default class UpdateRecurringReceipt implements IUseCase<UpdateRecurringReceipt_Input, RecurringItemValue | undefined>{
    constructor(
    ...
    async execute(input: UpdateRecurringReceipt_Input): Promise<RecurringItemValue | undefined> {
