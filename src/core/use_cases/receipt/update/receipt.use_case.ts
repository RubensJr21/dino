...
export default class UpdateReceipt implements IUseCase<UpdateReceipt_Input, ItemValue | undefined>{
    constructor(
    ...
    async execute(input: UpdateReceipt_Input): Promise<ItemValue | undefined> {
