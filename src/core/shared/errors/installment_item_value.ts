...
export class InstallmentItemValueNotFoundById extends Error {
  ...
  /**
   * @param {InstallmentItemValue["id"]} installment_item_value_id installment_item_value_id que gerou erro ao ser buscada
   */
  constructor(installment_item_value_id: InstallmentItemValue["id"]){
    super(`InstallmentItemValue id: '${installment_item_value_id}' not founded!`, {
...
export class InstallmentItemValueUnknownError extends Error {
  ...
  constructor(){
    super(`InstallmentItemValue not founded!`, {
      cause: `Unknown`
    })
  }
}
