...
export default function Create_UseCase_ItemValue_Update(variant: keyof typeof Variants_Of_ItemValue){
    return class UseCase_ItemValue_Update implements IUseCase<UpdateItemValue_Input, ItemValue | undefined>{
        constructor(
        ...
        async execute(input: UpdateItemValue_Input): Promise<ItemValue | undefined> {
