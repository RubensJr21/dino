...
export default function Create_UseCase_RecurringItemValue_MarkAsProcessed(variant: keyof typeof Variants_Of_ItemValue){
    return class UseCase_RecurringItemValue_MarkAsProcessed implements IUseCase<MarkRecurringItemValueAsProcessed_Input, RecurringItemValue>{
        constructor(
