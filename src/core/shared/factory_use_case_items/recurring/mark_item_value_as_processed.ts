...
export default abstract class UseCase_RecurringItemValue_MarkAsProcessed implements IUseCase<MarkRecurringItemValueAsProcessed_Input, boolean>{
  protected abstract variant: TypeOfVariants
  constructor(
    private repo_rec: IRepoRecurring,
    private repo_iv: IRepoItemValue
  ){}
  async execute(input: MarkRecurringItemValueAsProcessed_Input): Promise<boolean> {
