...
export default function Create_UseCase_InstallmentItemValue_Update(variant: keyof typeof Variants_Of_ItemValue){
  return class UseCase_InstallmentItemValue_Update implements IUseCase<UpdateInstallmentReceipt_Input, InstallmentItemValue | undefined>{
    constructor(
    ...
    async execute(input: UpdateInstallmentReceipt_Input): Promise<InstallmentItemValue | undefined> {
