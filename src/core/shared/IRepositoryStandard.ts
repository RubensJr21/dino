...
export interface IRepoStandard {
  ...
  /**
   * Retrieves all standard item values with their associated base item values, tags, transfer method types, and recurrence types.
   * @returns {Standard[]} An array of fully hydrated Standard instances
   */
  findAll(): Standard[];

  /**
   * Updates a standard item value and its associated base item value
