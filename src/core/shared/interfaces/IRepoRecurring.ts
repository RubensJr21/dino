...
export type InternalRepoErrorsRecurring = InternalRepoErrors<IRepoRecurring, "Recurring">
...
export interface IRepoRecurring {
  ...
  find_item_value(recurring_id: MRecurring["id"], item_value_id: MItemValue["id"]): Result<ItemValue>;
