...
export const balanceBank = sqliteTable(
  "balance_bank",
  {
    ...
    planned_receipts: integer("planned_receipts").notNull(),
    executed_receipts: integer("executed_receipts").notNull(),
...
// balance_cash
// ======================
export const balanceData = sqliteTable(
  "balance_data",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    last_compilation_date: integer("last_compilation_date", { mode: "timestamp" }).notNull()
  }
)