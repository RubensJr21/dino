...
export type IncomesRegisterParams = {
	id: string;
};

export default function IncomesRegister() {
	const { id } = useLocalSearchParams<IncomesRegisterParams>();
	...
	return (
		<BaseView>
			<ScrollView>
				<TitlePage>Registrar recebimento recorrente</TitlePage>
