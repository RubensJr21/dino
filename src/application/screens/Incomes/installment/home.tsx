...
import { Income } from "@src/application/models/Income";
import IncomeGroupedByDate from "./components/IncomesGroupByDate";
import { IncomesInstallmentStackParamList } from "./routes";

type Props = BottomTabScreenProps<IncomesInstallmentStackParamList, 'Home'>;
        ...
        renderItem={({ item }) => (
          <IncomeGroupedByDate
            ...
            navigateToEditPage={(expense) => {
              // navigation.navigate("IncomesEdit", {
              //   id: expense.id,
