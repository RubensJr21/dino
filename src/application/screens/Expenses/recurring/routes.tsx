...
export type ExpensesRecurringStackParamList = {
  Home: undefined;
  Register: undefined;
  Edit: EditRecurringParams;
}

const Stack = createNativeStackNavigator<ExpensesRecurringStackParamList>();

export default function ExpensesRecurringRoutes() {
  return (
    <Stack.Navigator
