...
import { ExpensesInstallmentStackParamList } from "./routes";

type ExpensesProps = BottomTabScreenProps<ExpensesInstallmentStackParamList, 'Home'>;

export default function Home({ navigation }: ExpensesProps) {
        ...
        renderItem={({ item }) => (
          <ExpenseGroupedByDate
            ...
            navigateToEditPage={(expense) => {
              // navigation.navigate("ExpensesEdit", {
              //   id: expense.id,
