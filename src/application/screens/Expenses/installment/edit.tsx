...
type EditInstallmentProps = BottomTabScreenProps<ExpensesInstallmentStackParamList, 'Edit'>;

export default function EditInstallment({route, navigation}: EditInstallmentProps) {
