...
import MarkPaymentStandardAsUnProcessed from "@src/core/use_cases/payment/standard/mark_as_unprocessed.use_case";
...
async function mark_as_unprocessed({
  ...
  await db.transaction(async tx => {
    ...
    const mark_as_unprocessed = new MarkPaymentStandardAsUnProcessed(repo, repo_iv);
