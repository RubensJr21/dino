...
import RegisterPaymentStandard from "@src/core/use_cases/payment/standard/register.use_case";
...
async function register({
  ...
  await db.transaction(async tx => {
    ...
    const register_standard = new RegisterPaymentStandard(repo, repo_iv);
